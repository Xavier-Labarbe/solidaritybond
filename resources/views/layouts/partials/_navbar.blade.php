  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-item nav-link active" href="#">Espace de rendez-vous <span class="sr-only">(current)</span></a>
        <a class="nav-item nav-link" href="conversations">Mise en relation</a>
        <a class="nav-item nav-link" href="#">Calendrier</a>
        <a class="nav-item nav-link disabled" href="/register" tabindex="-1" aria-disabled="true">S'inscrire</a>
      </div>
    </div>
  </nav>
</header>