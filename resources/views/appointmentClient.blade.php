        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div> @php
                    ...
                    $appointments =
                    \DB::table('appointments')->join('users','appointments.to_id','=','users.id')->where([['to_id','=',Auth::user()->id],['appointments.status','=',1]])
                    ...
                    "<li class=\"list-group-item\">
                        <div class=\"calendar_container\">
                            ...
                            <div class=\" card\" style=\"width: 45rem;\">
                                <div class=\"card-body\" style=\"display: flex; align-items: center; justify-content:
                                    space-between;\">
                                    <div>
