...
<div class="container">
    ...
    <div class="card bg-light">
        <article class="card-body mx-auto" style="max-width: 400px;">
            ...
            <p class="text-center">Fréro met toi bien</p>
            ...
            <form>
                ...
                <div class="form-group input-group">
                    ...
                    <input class="form-control" placeholder="Confirmation MDP" type="password">
                </div> <!-- form-group// -->
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block">Creer son sompte</button>
                </div> <!-- form-group// -->
                <p class="text-center">Vous avez déjà un compte ? <a href="">connectez vous ici</a> </p>
            </form>
        </article>
    </div> <!-- card.// -->
